(function($) {
    ...
    // This Code is for back to top button which is not needed
    // var back = $("#myBtn"),
    //     body = $("body, html");
    // $(window).on('scroll', function() { if ($(window).scrollTop() > $(window).height()) { back.css(); } else { back.css(); } });
